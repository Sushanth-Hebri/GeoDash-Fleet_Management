...
const menuItems = [
    ...
    { text: 'Reports', icon: <SearchIcon /> },
    { text: 'Settings', icon: <MenuIcon /> },
            ...
            <List>
                {menuItems.map((item, index) => (
                    <ListItem key={index} disablePadding>
                        <ListItemButton
                            onClick={() => item.text === 'Dashboard' ? handlePanelClose() : handlePanelOpen(item.text)} // Handle Dashboard click
                            sx={{
                                '&:hover': {
        ...
        <Box sx={{ display: "flex" }}>
            ...
            <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}>
                <Toolbar>
                    ...
                    <TextField
                        ...
                        sx={{ bgcolor: 'background.paper', borderRadius: 1, width: 250 }}
            ...
            {openPanel && (
                <Box
                    sx={{
                        position: 'fixed',
                        top: 64, // Adjusted to account for the AppBar height
                        left: drawerWidth,
                        right: 0,
                        bottom: 0,
